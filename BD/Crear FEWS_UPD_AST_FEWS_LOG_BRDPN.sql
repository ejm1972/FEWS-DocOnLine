...
where fenc.id=@id
	...
	from fews_encabezado fenc
		, fews_xml fxml
		, fews_qr fqr
		, BRD3.FINN_BRD.dbo.ast_fews_log astl
...
--select * from BRD3.FINN_BRD.dbo.ast_fews_log where cuit_empresa='30711897581' and tipo_comprobante='01' and PUNTO_VENTA='0002' and numero_comprobante='00000003'
