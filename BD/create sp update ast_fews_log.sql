drop procedure fews_upd_ast_fews_log
go

CREATE PROCEDURE [FEWS_UPD_AST_FEWS_LOG]
	@id int
AS
BEGIN 
SET NOCOUNT ON
	
	update FINNEGANS.FINN_Admifarm.dbo.AST_FEWS_LOG
	...
	from fews_encabezado fenc
		, fews_xml fxml
		, FINNEGANS.FINN_Admifarm.dbo.ast_fews_log astl
...
exec fews_upd_ast_fews_log 1

select * from FINNEGANS.FINN_Admifarm.dbo.ast_fews_log where cuit_empresa='30711897581' and tipo_comprobante='01' and PUNTO_VENTA='0002' and numero_comprobante='00000003'
