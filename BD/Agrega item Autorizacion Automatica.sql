...
if not exists(select * from ITEM where descripcion = N'Autorización Automática')
begin
	INSERT [dbo].[ITEM] ([id], [id_seccion], [descripcion], [orden], [url], [icon], [codigo], [TARGET]) 
		VALUES (@id_item, 3, N'Autorización Automática', @orden_item, N'/secure/facturacion/fewsMovimientosSql.xhtml', N'flaticon-log_oper', N'SI_REG_AUT', NULL)
