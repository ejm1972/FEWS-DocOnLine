...
/****** Object:  StoredProcedure [dbo].[AST_PIDE_CAE_LOTE]    Script Date: 03/25/2019 07:44:38 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[AST_PIDE_CAE_LOTE]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[AST_PIDE_CAE_LOTE]
GO
...
-- =============================================
CREATE PROCEDURE [dbo].[AST_PIDE_CAE_LOTE] 
