...
if not exists(select * from ITEM where descripcion = N'Exportación RG3685')
begin
	INSERT [dbo].[ITEM] ([id], [id_seccion], [descripcion], [orden], [url], [icon], [codigo], [TARGET]) 
		VALUES (@id_item, 3, N'Exportación RG3685', @orden_item, N'/secure/cuentas/exportaRG3685.xhtml', N'flaticon-exportacion', N'SI_CUE_AUT', NULL)
