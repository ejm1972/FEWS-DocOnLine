/**Copyright 2003 by Andres Ederra.
 ...
 * The initial developer of jbars is Andres Ederra. Portions created by the initial
 * Developer of jbars are Copyright (C) 2003 by Andres Ederra
 **/
package org.jbars;
...
public abstract class Barcode {
	...
	**/
	...
	public static synchronized Image createImage(
		...
		try {
			...
			logger.debug("Error rotating image: " + e.getMessage());
		}
		return image;
	}
	...
	*/
	 ...
	 * Fecha de creacion: (26/02/2003 12:20:14)
	 * @return int
