...
public class TimerTaskSql extends TimerTask {
	...
	public void run() {
		...
		try {
			...
			logger.info("***");
			logger.info("*** Ini TimerTaskSql *** " + new Date() + " - " + String.valueOf(countTimerTaskSql));
			logger.info("***");
			...
			logger.info("***");
			logger.info("*** Fin TimerTaskSql *** - " + String.valueOf(countTimerTaskSql));
			logger.info("***");
			...
			if (applicationException!=null) {
				...
				logger.error("***");
				logger.error("*** Fin TimerTaskSql *** - " + String.valueOf(countTimerTaskSql));
				logger.error("***");
			}
		}
