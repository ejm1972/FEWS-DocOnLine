...
//
//@Component(value = "timer.AutorizadorFewsTask2")
//public class AutorizadorFewsTask implements Runnable {
...
//	private ScheduledFuture<?> scheduledFutureFewsControl;
//	private Map<ScheduledFuture<?>, Boolean> scheduledFutureFewsMap = new HashMap<>();
//	private int countScheduledTaskFews;
//	private int countScheduledTaskFewsAnterior;
//	private int delayScheduledTaskFews;
//
//	public AutorizadorFewsTask() {
//		this.interfaz = 9901;
//		this.clave = "1234";
//	}
//
//	public AutorizadorFewsTask(Integer interfaz, String clave) {
...
//		
//			logger.info("***");
//			logger.info("*** schedulerFews " + poolSchedulerFews.getThreadNamePrefix() + "* shutdown *** " + new Date() + " - " + countScheduledTaskFews);
//			logger.info("***");
//			
...
//				
//				logger.info("***");
//				logger.info("*** Ini runAutorizadorFewsTask *** " + new Date() + " - " + countScheduledTaskFews);
//				logger.info("***");
//	
//				procesarPendientes();
...
//					logger.error(e.getCause()!=null ? e.getCause().toString() : e.toString());
//			}
//		
//			logger.debug("***");
//			logger.debug("*** Fin runAutorizadorFewsTask *** - " + countScheduledTaskFews);
//			logger.debug("***");
//	
//		}
//	
...
//
//		logger.debug("Ejecucion registrarAuditoriaIni()");
//
...
//		
//		//obj   : {"id": value, "id": obj, "id": arr, ...}
//		//arr   : [obj, obj, ...]
//		
//		StringBuilder sb = new StringBuilder();
//		sb.append("{");
//		sb.append("lanzador: TimerSQL.AutorizadorSql.procesarPendientes.autorizarComprobante");
...
//
//		logger.debug("Ejecucion registrarAuditoriaFin()");
//		
...
//			//respI.cargarError(new Response(ErrorEnum.SIN_ERROR));
//
//			ResponseAutorizarComprobante respA = new ResponseAutorizarComprobante();
//			respA.setEsReintento(false);
//			//respA.cargarError(new Response(ErrorEnum.SIN_ERROR));
//
...
//
//					//procesar error en el inicio de sesion !!!!!!!!!!!!!!
//
...
//					logger.debug("Fin Ejecucion registrarAuditoriaIni()");
//					
//					try {
//
...
//						logger.debug("Fin Ejecucion registrarAuditoriaFin()");
//						
//					}
//
//				} else {
